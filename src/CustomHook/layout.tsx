...
const PlayerProfileCard = () => {
    ...
    useEffect(() => {
        ...
        playerStore.get.info(id as any)

    }, [id])

    const player = playerStore.player.detail;
                ...
                <div className="row">
                    <div className="col-md-6 p-3">
                        <div className="player-image">
                            ...
                            {/* <img
                                src={player?.image_url || '/batter.png'}
                    ...
                    <div className="col-md-6 p-3">
                        <div className="player-info">
                            <h1 className="player-name"><span className="first-name">{player?.name}</span> </h1>
